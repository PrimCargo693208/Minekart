...
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s as @p[gamemode=!spectator,distance=...5] run function minekart:player/hotbar
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s as @p[gamemode=!spectator,distance=...5] run function minekart:items/ui
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s as @p[gamemode=!spectator,distance=...5, tag=!minekart_player] run scoreboard players add @s rounds 0
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s as @p[gamemode=!spectator,distance=...5] run tag @s add minekart_player
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s as @p[gamemode=!spectator,distance=...5] run tag @s add player
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s unless entity @n[tag=com_player,tag=mk2] as @p[gamemode=!spectator,distance=.6..1.5, tag=minekart_player] run function minekart:ui/clear_player_hotbar
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s unless entity @n[tag=com_player,tag=mk2] as @p[gamemode=!spectator,distance=.6..1.5, tag=minekart_player] run scoreboard players add @s rounds 0
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s unless entity @n[tag=com_player,tag=mk2] as @p[gamemode=!spectator,distance=.6..1.5] run tag @s remove minekart_player
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s unless entity @n[tag=com_player,tag=mk2] as @p[gamemode=!spectator,distance=.6..1.5] run tag @s remove player
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s unless entity @n[tag=com_player,tag=mk2] as @p[gamemode=!spectator,distance=.6..4, tag=!minekart_player] run title @s actionbar ["⚠ Deine Hotbar wird gleich glöscht ⚠"]
...
execute as @a[scores={rounds=4..}, tag=!finished] run gamemode spectator
...
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s as @p[distance=...5, tag=!next_round] if block ~ ~-1.5 ~ minecraft:diamond_block run title @s[scores={rounds=2..3}] title ["",{"text":"Runde ","bold":true,"color":"dark_aqua"},{"score":{"name":"@s","objective":"rounds"},"bold":true,"color":"gold"},{"text":"/3","bold":true,"color":"gold"}]
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s as @p[distance=...5, tag=!next_round] if block ~ ~-1.5 ~ minecraft:diamond_block run title @s[scores={rounds=4..}] title ["",{"text":"FINISH!","bold":true,"color":"gold"}]
...
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s at @p[distance=...5, scores={speed=10..},tag=minekart_player] positioned ~ ~.41249938686374 ~ run tp @s ~ ~ ~ ~ 0
...
execute as @e[tag=mk2, tag=minekart2, tag=kart] at @s if entity @p[distance=...5, scores={speed=1..}] run tp @s ~ ~ ~ ~90 0
