# 1 = Roter Pilz
execute as @a[scores={item.used=1..}] at @s if entity @s[nbt={SelectedItem:{components: {"minecraft:custom_model_data": 1}, id: "minecraft:warped_fungus_on_a_stick"}}] run scoreboard players set @s speed 120
...
# 2 = Banane (1)
execute as @a[scores={item.used=1..}] at @s if entity @s[nbt={SelectedItem:{components: {"minecraft:custom_model_data": 2}, id: "minecraft:warped_fungus_on_a_stick"}}] run summon armor_stand ~ ~ ~ {Invisible:true,Small:true,Motion:[0.0,0.0,0.0],Tags:["mk2","minekart2","item.dropped","banana"],ArmorItems:[{},{},{},{id:"minecraft:warped_fungus_on_a_stick",count:1,components:{"minecraft:custom_model_data":2}}]}
execute as @a[scores={item.used=1..}] at @s if entity @s[nbt={SelectedItem:{components: {"minecraft:custom_model_data": 2}, id: "minecraft:warped_fungus_on_a_stick"}}] as @n[tag=mk2,tag=item.dropped] at @s run function minekart:items/use/banana
