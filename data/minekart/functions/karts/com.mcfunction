...
execute as @e[tag=mk2,tag=com_kart] at @s if entity @e[tag=mk2,tag=goal,distance=..10] if score @s pos matches 3.. run scoreboard players add @s rounds 1
execute as @e[tag=mk2,tag=com_kart] at @s if entity @e[tag=mk2,tag=goal,distance=..10] if score @s pos matches 8.. run scoreboard players set @s pos 3
